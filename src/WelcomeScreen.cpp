// NinjaDBG v1.2.0 - WelcomeScreen implementation
...
std::string WelcomeScreen::welcomeMessage() {
    return R"WELCOME(
Welcome to NinjaDBG v1.2.0 — Stealth Debugger
...
IMPORTANT: NinjaDBG v1.2.0 is CLI-only. The GUI was removed in v1.2.0.
...
std::string WelcomeScreen::eulaText() {
    return R"EULA(
==========================================================================
   NinjaDBG v1.2.0 — Apache License 2.0 (Open Source)
==========================================================================
...
3. CLI-ONLY
   ...
   The GUI was removed in v1.2.0. NinjaDBG is now CLI-only.
