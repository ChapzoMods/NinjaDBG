// NinjaDBG v1.1.4 - Entry point
// Open Source (Apache-2.0) - by Chapzoo
//
// NinjaDBG v1.1.4 is CLI-only. The GUI was removed in v1.1.4.
//
// Usage:
...
int main(int argc, char** argv) {
    ...
    if (show_help) {
        std::cout <<
            "NinjaDBG v1.1.4 - Stealth Debugger\n"
            ...
            "The GUI was removed in v1.1.4. The headless CLI exposes the full\n"
