// NinjaDBG v1.2.0 - Entry point
// Open Source (Apache-2.0) - by Chapzoo
//
// NinjaDBG v1.2.0 is CLI-only. The GUI was removed in v1.2.0.
//
// Usage:
...
int main(int argc, char** argv) {
    ...
    if (show_help) {
        std::cout <<
            "NinjaDBG v1.2.0 - Stealth Debugger\n"
            ...
            "The GUI was removed in v1.2.0. The headless CLI exposes the full\n"
