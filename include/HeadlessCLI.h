...
//   set <addr> = <bytes>
//   disas [addr] [count]     [v1.1.4 — full x86-64 decoder]
//   edit [addr]              [v1.1.4 — interactive TUI memory editor]
//   decomp [addr]            [v1.1.4 — native C decompilation via RetDec/angr]
//   decomp file <bin> [addr] [v1.1.4 — decompile whole file or function]
//   decomp <list|api|set>    [v1.1.4 — backend management]
//   backtrace | bt
//   patch <list|apply|nop|save|undo|info>
//   stealth <list|on|off>
//   kernel <status|load|unload>
//   target <binary>          (load binary for static patching)
//   script <list|run|api>    [v1.1.4 — Lua + Python scripting]
//   help [cmd]
//   quit | q
#pragma once
