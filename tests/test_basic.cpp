// NinjaDBG v1.1.4 - Basic CLI test runner
// Open Source (Apache-2.0) - by Chapzoo
//
// Verifies the CLI binary exists, prints help, runs in batch mode, that the
// banner says "v1.1.4" and "Apache-2.0", and that the decomp / pretty /
...
static void test_help_flag() {
    ...
    check(contains(out, "v1.1.4"),     "--help output mentions v1.1.4");
...
static void test_batch_mode() {
    ...
    check(contains(out, "NinjaDBG v1.1.4 CLI commands"),
...
static void test_banner() {
    ...
    check(contains(out, "v1.1.4"),
          "banner contains the version string v1.1.4");
...
int main(int /*argc*/, char** /*argv*/) {
    ...
    ::printf("NinjaDBG v1.1.4 basic test runner\n");
