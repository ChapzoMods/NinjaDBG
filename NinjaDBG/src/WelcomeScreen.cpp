// NinjaDBG v1.1.2 - WelcomeScreen implementation
...
std::string WelcomeScreen::welcomeMessage() {
    return R"WELCOME(
Welcome to NinjaDBG v1.1.2 — Stealth Debugger
...
IMPORTANT: NinjaDBG v1.1.2 is CLI-only. The GUI was removed in v1.1.2.
...
std::string WelcomeScreen::eulaText() {
    return R"EULA(
==========================================================================
   NinjaDBG v1.1.2 — Apache License 2.0 (Open Source)
==========================================================================
...
3. CLI-ONLY
   ...
   The GUI was removed in v1.1.2. NinjaDBG is now CLI-only.
